...
async function transcodeVideo(video) {
  ...
  return {
    formats: [
      { quality: '1080p', url: `https://cdn.example.com/videos/${video.id}/1080p.mp4`, size: 524288000, bitrate: 8000 },
      { quality: '720p', url: `https://cdn.example.com/videos/${video.id}/720p.mp4`, size: 262144000, bitrate: 4000 },
      { quality: '480p', url: `https://cdn.example.com/videos/${video.id}/480p.mp4`, size: 131072000, bitrate: 2000 },
    ],
    duration: 300,
  };
}
